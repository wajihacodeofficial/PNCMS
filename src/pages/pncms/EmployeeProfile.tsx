    ...
    <AppShell>
      <PageHeader
        ...
        actions={
          <>
            ...
            <Btn
              variant="gold"
              onClick={() => navigate('/personnel/edit/PN-CIV-1042')}
            >
      ...
      <div className="panel mb-5 overflow-hidden">
        ...
        <div className="bg-gradient-command px-7 py-6 text-white flex items-center gap-6">
          <div className="w-24 h-28 bg-white/10 border border-white/20 rounded-sm flex items-center justify-center text-3xl font-heading font-extrabold">
            MTK
          </div>
          <div className="flex-1">
            <div className="label-mil text-white/70">
              PN-CIV-1042 · EMP-2041
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 mt-3 text-sm text-white/80">
              <span className="flex items-center gap-1.5">
                <Building2 className="w-4 h-4" /> Administration · BPS-14
              </span>
              <span className="flex items-center gap-1.5">
                <IdCard className="w-4 h-4" /> 42101-1234567-1
              </span>
              <span className="flex items-center gap-1.5">
                <Phone className="w-4 h-4" /> +92-300-1234567
              </span>
              <span className="flex items-center gap-1.5">
                <Mail className="w-4 h-4" /> tariq.k@pn.gov.pk
              </span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-4 gap-5 mb-5">
        ...
        <StatCard
          label="Sanctions YTD"
          value="08"
          sub="6 approved · 2 pending"
          accent="info"
          icon={<ClipboardList className="w-5 h-5" />}
        />
        <StatCard
          label="OT Earnings YTD"
          value="Rs. 142K"
          sub="356 hours billed"
          accent="success"
