...
const INITIAL_NOTIFICATIONS: NotificationItem[] = [
  {
    id: '1',
    t: 'Sanction SNC-2026-0142 awaiting Director approval',
    time: '12 min ago',
    tag: 'Sanction',
    isRead: false,
  ...
  {
    id: '2',
    t: 'Sanction SNC-2026-0138 pending Section Officer verification',
    time: '2 hr ago',
    tag: 'Sanction',
    isRead: false,
    group: 'Pending Approvals',
  ...
  {
    id: '3',
    t: 'Leave Application LV-2026-091 (Bilal A. Siddiqui) awaiting verification',
    time: '4 hr ago',
    tag: 'Leave',
    isRead: false,
    group: 'Pending Approvals',
  ...
  {
    id: '4',
    t: 'Payment batch APR-2026-C ready for disbursement (Rs. 84,200)',
    time: 'Today 09:10',
    tag: 'Payment',
    isRead: false,
  ...
  {
    id: '5',
    t: '3 employees awaiting overtime payment for Mar 2026',
    time: 'Yesterday',
    tag: 'Payment',
    isRead: true,
    group: 'Pending Payments',
  ...
  {
    id: '6',
    t: 'Saima Nawaz exceeded EL allocation by 2 days',
    time: '1 hr ago',
    tag: 'Leave',
    isRead: false,
    group: 'Leave Conflicts',
  },
  {
    id: '7',
    t: 'Two staff in Logistics on simultaneous CL — coverage warning',
    time: '3 hr ago',
    tag: 'Leave',
    isRead: true,
    group: 'Leave Conflicts',
  ...
  {
    id: '8',
    t: 'Auto-backup completed successfully (248 MB)',
    time: '02:00',
    tag: 'System',
    isRead: true,
    group: 'System Alerts',
  ...
  {
    id: '9',
    t: 'Failed login attempt from 172.31.4.12 — review audit log',
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 pr-8">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <Badge variant={it.isRead ? 'neutral' : 'info'}>
                        {it.tag}
                      </Badge>
