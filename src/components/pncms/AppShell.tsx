          ...
          <header className="h-14 bg-card border-b border-border flex items-center justify-between px-6 sticky top-0 z-30">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-1.5 border-r border-border pr-4">
                <button
                  onClick={() => navigate(-1)}
                  className="p-1.5 rounded-sm hover:bg-muted text-muted-foreground hover:text-primary transition-colors"
                  title="Go Back"
                >
            ...
            <div className="flex items-center gap-5">
              ...
              <div
                className="flex items-center gap-3 cursor-pointer hover:bg-muted/30 transition-colors px-2 py-1 rounded-sm"
...
export const PageHeader = ({
  ...
  <div className="flex items-end justify-between mb-6 pb-5 border-b border-border">
    <div>
      <h1 className="text-3xl text-primary leading-none uppercase tracking-tight font-heading font-black italic">
        {title}
      </h1>
